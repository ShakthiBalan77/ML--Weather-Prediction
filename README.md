...
## Algorithm
1.Load and preprocess data – Import the dataset, convert the time column to datetime, sort the data, and fill missing values using interpolation.        
2.Feature engineering – Create new features such as hour-based cyclic features (hour_sin, hour_cos) and lag features (lag1, lag2) for temperature, PM2.5, and solar radiation.       
3.Model training – Split the dataset into training and testing sets and train the Random Forest Regressor model using the selected features.          
4.Prediction and evaluation – Predict the target values, calculate performance metrics (R², MAE), visualize the results, and forecast the next values using the latest data. 
...
df = pd.read_csv(r"C:\Users\Shakt\weather-station-eee-block_2024_07_13.csv")
...
<img width="1097" height="493" alt="image" src="https://github.com/user-attachments/assets/0f64c138-c577-4fa8-b770-b81faa0bda54" />
<img width="1112" height="408" alt="image" src="https://github.com/user-attachments/assets/76ed3d3b-b2dd-40ae-9893-c2d805c346dd" />
<img width="1132" height="503" alt="image" src="https://github.com/user-attachments/assets/b5b63d69-2d67-41aa-84b7-799dc97ef54f" />
